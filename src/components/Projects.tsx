...
const projects = [{
  ...
  highlights: ["Reduced computational latency by 40%", "Implemented novel optimization algorithms", "Published research findings"]
}, {
  ...
  highlights: ["Real-time data processing pipeline", "Interactive visualization dashboard", "Scalable cloud architecture"]
}, {
  ...
  highlights: ["Low-power system design", "Wireless sensor networking", "Real-time operating system integration"]
}, {
  ...
  highlights: ["Fault-tolerant architecture", "Auto-scaling capabilities", "High-throughput data processing"]
}];
const Projects = () => {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-4">
            ...
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 to-white bg-clip-text text-transparent">Projects</h2>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-blue-500/20 hover:border-blue-400/40 transition-all duration-500 hover:scale-105 group">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mb-6">
                      ...
                      <ul className="space-y-2">
                        {project.highlights.map((highlight, hIndex) => <li key={hIndex} className="flex items-start text-blue-100">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.map((tech, techIndex) => <span key={techIndex} className="px-3 py-1 bg-blue-900/30 text-blue-200 rounded-full text-sm border border-blue-500/30">
                            {tech}
                          </span>)}
                      </div>
                    </div>
